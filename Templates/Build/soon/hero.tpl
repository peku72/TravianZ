    ...
    <table class="new_building" cellpadding="1" cellspacing="1">
		...
		<tr>
			<td>
				<a href="#" onClick="return Popup(23,4);"><?php echo echo MAINBUILDING ?></a> <span title="+2"><?php echo LEVEL ?> 3</span>, <a href="#" onClick="return Popup(14,4);"><?php echo RALLYPOINT ?></a> <span title="+1"><?php echo LEVEL ?> 1</span>
			</td>
		</tr></tbody>
	</table>
